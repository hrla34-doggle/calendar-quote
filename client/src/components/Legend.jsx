    ...
    return (
      <div className="AK-container-legend">
        ...
        <div className="AK-tooltip1">
          <img className="AK-legend-img" src="https://calendar-trips.s3-us-west-1.amazonaws.com/limited_availability.png" alt="limited_availability" />
        ...
        <div className="AK-tooltip2">
          <img className="AK-legend-img" src="https://calendar-trips.s3-us-west-1.amazonaws.com/1_seat_left.png" alt="1_seat_left" />
        ...
        <div className="AK-tooltip3">
          <img className="AK-legend-img" src="https://calendar-trips.s3-us-west-1.amazonaws.com/definitive_departure.png" alt="definitive_departure" />
        ...
        <div className="AK-tooltip4">
          <img className="AK-legend-img" src="https://calendar-trips.s3-us-west-1.amazonaws.com/deals_available.png" alt="deals_available" />
